    ...
    <>
      ...
      >
        <div className="HPNXA06qJ7">
          <div
            className="column padding-x-32 padding-bottom-40 gap-20"
            style={{
              display: "flex",
              flexDirection: "column",
              paddingLeft: "32px",
          ...
          >
            ...
            >
              ...If you wanna get in touch or talk. Feel free to say hi or talk
              to me. Just click the contack link below and fill the form or send
              an email to{" "}
              <a
                href="https://mail.google.com/mail/u/1/?fs=1&to=gemeliezerespiritu@gmail.com&tf=cm"
                target="_blank"
                style={{
                  color: "black",
